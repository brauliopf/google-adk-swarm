...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_go_to_url_success(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_go_to_url_strips_whitespace(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_go_to_url_with_path(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_simple_html(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_script_tags(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_style_tags(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_nav_tags(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_footer_tags(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_aside_tags(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_header_tags(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_preserves_main_content(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_escapes_quotes(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_empty_page(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_length_limit(self, mock_driver):
...
#     @patch('support_agent.sub_agents.crawler.agent.driver')
#     def test_get_page_text_removes_path_tags(self, mock_driver):
